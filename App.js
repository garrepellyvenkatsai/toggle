  ...
  return (
    <div className="App">
      ...
      <div className="controls">
        ...
        <button className="sample-btn" onClick={() => handleButtonClick(isBpmn ? 'bpmn' : 'flow')}>
          {isBpmn ? 'Load BPMN Example' : 'Load Mermaid Example'}
        </button>
        {!isBpmn && (
          <>
      ...
      <div className="mainContent">
        ...
        <div ref={diagramRef} className="diagramContainer">
          {isBpmn ? (
